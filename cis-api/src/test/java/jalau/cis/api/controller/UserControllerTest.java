...
public class UserControllerTest {
    ...
    public void shouldRegisterUserSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/users")
                ...
                .andExpect(jsonPath("$.message").value("User registered successfully (stored as plain text)"));
    }
    ...
    public void shouldReturnBadRequestForInvalidBase64() throws Exception {
        ...
        mockMvc.perform(post("/users")
                ...
                .andExpect(jsonPath("$.error").value("Invalid 'hash' format. Password must be Base64 encoded."));
    }
}
